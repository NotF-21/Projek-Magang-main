...
@include('layout.navbar')
        ...
        <div class="container py-5">
            <div class="row justify-content-end">
                <div class="col-lg-8 text-center text-lg-start">
                    ...
                    <p class=" text-white mb-md-4"><a class="text-white" href="{{url('/')}}">Beranda</a> > Rawat Inap</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-3 px-5">
        <div class="row mb-2">
            <div class="col-12 justify-content-center d-flex">
                ...
                <img id="expandedImg" src="{{asset("images/ri1.jpg")}}" alt="" width="50%">
        ...
        <div class="row mb-4 justify-content-center">
            <div class="column">
              <img src="{{asset("images/ritab1.jpg")}}" alt="" width="120px" height="90px" onclick="tabGal(this);">
            </div>
            <div class="column">
              <img src="{{asset("images/ritab2.jpg")}}" alt="" width="120px" height="90px" onclick="tabGal(this);">
            </div>
            <div class="column">
              <img src="{{asset("images/ritab3.jpg")}}" alt="" width="120px" height="90px" onclick="tabGal(this);">
            </div>
            <div class="column">
              <img src="{{asset("images/ri4.jpg")}}" alt="" width="120px" height="90px" onclick="tabGal(this);">
            </div>
          </div>
        <div class="row justify-content-center d-flex mx-3 px-3">
            <h2 class="d-inline-block text-dark text-uppercase border-bottom border-5">Rawat Inap</h2>
    ...
    <script>
        function tabGal(imgs) {
            ...
            if (sl==1) expandImg.src = "{{asset("images/ri1.jpg")}}";
            else if (sl==2) expandImg.src = "{{asset("images/ri2.jpg")}}";
            else if (sl==3) expandImg.src = "{{asset("images/ri3.jpg")}}";
            else if (sl==4) expandImg.src = "{{asset("images/ri4.jpg")}}";
        ...
        function prev() {
            ...
            if (sl==1) expandImg.src = "{{asset("images/ri4.jpg")}}";
            else if (sl==2) expandImg.src = "{{asset("images/ri1.jpg")}}";
            else if (sl==3) expandImg.src = "{{asset("images/ri2.jpg")}}";
            else if (sl==4) expandImg.src = "{{asset("images/ri3.jpg")}}";
        ...
        function next() {
            ...
            if (sl==1) expandImg.src = "{{asset("images/ri2.jpg")}}";
            else if (sl==2) expandImg.src = "{{asset("images/ri3.jpg")}}";
            else if (sl==3) expandImg.src = "{{asset("images/ri4.jpg")}}";
            else if (sl==4) expandImg.src = "{{asset("images/ri1.jpg")}}";
